 ...
 */
public class BigItemListActivity extends Activity {
    public int source;

    public JSONArray items;
    public BigItemListAdapter listAdapter;
    public View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(view == null) {
            ...
            view = getLayoutInflater().inflate(R.layout.activity_bigitemlist, null);
            setContentView(view);
            ...
            listAdapter = new BigItemListAdapter(this, getLayoutInflater());
            listAdapter.downscale = new BitmapDownscale("540", 540);
            if (getIntent() != null) {
                listAdapter.separator_color = getIntent().getIntExtra("color", 0);
            }
